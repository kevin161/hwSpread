...
import com.leisurely.spread.UI.adapter.ShoubiDetailAdapter;
...
public class ShoubiDetailActivity extends BaseActivity {

    private XclModel xclModel;
    private ShoubiDetailAdapter adapter;
    ...
    protected void initView() {
        ...
        list = new ArrayList<>();
        adapter = new ShoubiDetailAdapter(this, list);
    ...
    protected void initData() {
        ...
        xclModel.collectList(pageNum, pageSize);
    ...
    public void collectListSuccess(List<Shoubi> bean) {
        if (pageNum == 1) {
            list = bean;
