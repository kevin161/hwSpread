...
import com.leisurely.spread.util.NetWork;
...
public class HtmlImageGetter implements ImageGetter{
    ...
    public HtmlImageGetter(TextView htmlText, String imgPath, Drawable defaultDrawable,BaseActivity activity){
        _htmlText = htmlText;
        _imgPath = imgPath;
    ...
    public Drawable getDrawable(String imgUrl) {
        ...
        if(FileUtil.exists(imgKey)){
            ...
            if(drawable != null){
                ...
                ToastUtil.showToast("请去设置里开启app的文件存储权限");
