...
import com.leisurely.spread.UI.adapter.ShareWinAdapter;
...
public class ShareWinActivity extends BaseActivity {

    private XclModel xclModel;
    private ShareWinAdapter adapter;
    ...
    protected void initView() {
        ...
        list = new ArrayList<>();
        adapter = new ShareWinAdapter(this, list);
    ...
    protected void initData() {
        ...
        xclModel.shareWin(pageNum, pageSize);
    ...
    public void shareWinSuccess(List<QuantificationWin> bean) {
        if (pageNum == 1) {
            list = bean;
