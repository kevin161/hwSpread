...
import com.leisurely.spread.UI.adapter.ZhuanbiDetailAdapter;
...
public class ZhuanbiDetailActivity extends BaseActivity {

    private XclModel xclModel;
    private ZhuanbiDetailAdapter adapter;
    ...
    protected void initView() {
        ...
        list = new ArrayList<>();
        adapter = new ZhuanbiDetailAdapter(this, list);
    ...
    protected void initData() {
        ...
        xclModel.transferList(pageNum, pageSize);
    ...
    public void transferListSuccess(List<Shoubi> bean) {
        if (pageNum == 1) {
            list = bean;
