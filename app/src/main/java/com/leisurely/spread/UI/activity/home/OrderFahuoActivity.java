...
//        setTitle("发货管理");
        textView_title_title_bar = findViewById(R.id.textView_title_title_bar);
        textView_title_title_bar.setText("已发货");
        ...
        list = new ArrayList<>();
        adapter = new OrderFahuoAdapter(this, list);
    ...
    public void onResume() {
        super.onResume();
        isAll = true;
        xclModel.getOrders(1, list.size(), status);
    }
    ...
    protected void initData() {
        ...
        xclModel.getOrders(pageNum, pageSize, status);
...
//                    }
    ...
    public void showAlert() {
        ...
        text2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog1.dismiss();
                xclModel.alertOrderStatus(list.get(position).getId());
            }
        });
        dialog1.show();
    }
    ...
    public void showSuccess() {
        ...
        TextView alert_title = layout.findViewById(R.id.alert_title);
        alert_title.setText("确认收货成功");
        TextView alert_content = layout.findViewById(R.id.alert_content);
        alert_content.setText("确认收货已提交!");
        alert_content.setVisibility(View.GONE);
        TextView text1 = layout.findViewById(R.id.awardpage_button1);
        text1.setText("取消");
...
//                xclModel.alertOrderStatus(list.get(position).getId());
    ...
    public void alertOrderStatusSuccess(JSONObject json) {
