...
//        textView_right_title_bar.setText("确认发货");
//        textView_right_title_bar.setOnClickListener(this);
        agreement_web_view.addJavascriptInterface(new OrderQueryActivity.JsInteration(), "android");
...
//        }
    ...
    private void take() {
        ...
        OrderQueryActivity.this.startActivityForResult(chooserIntent, FILECHOOSER_RESULTCODE);
    }
