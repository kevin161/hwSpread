package com.leisurely.spread.widget.pwd;
...
public class PayPassView extends RelativeLayout {
    ...
    private View mPassLayout,viewSpace;//布局
    ...
    private void initView() {
        ...
        txtAmount = mPassLayout.findViewById(R.id.txtAmount);
        viewSpace = mPassLayout.findViewById(R.id.viewSpace);
        layoutAmount = mPassLayout.findViewById(R.id.layoutAmount);
    ...
    public void setAmountVisibility(String amount) {
        layoutAmount.setVisibility(VISIBLE);
        txtAmount.setText(amount);

        for (int i = 0; i < 6; i++) {
            mTvPass[i].setTextColor(Color.parseColor("#EC3537"));
        }
    }
