...
package com.leisurely.spread.framework.screenpercent;
...
import com.leisurely.spread.framework.screenpercent.PercentLayoutHelper.PercentLayoutInfo;
...
public class PercentFrameLayout extends FrameLayout {
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams
        ...
        public LayoutParams(int width, int height) {
            super(width, height);
            mPercentLayoutInfo = new PercentLayoutInfo();
        }
