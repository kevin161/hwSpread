...
//import com.leisurely.xxy.UI.activity.money.ZhuanbiActivity;
//
//import java.io.File;
...
// */
//public class CaptureManagerUtil {
//    private static final String TAG = CaptureManagerUtil.class.getSimpleName();
//
...
//    };
//
//    public CaptureManagerUtil(Activity activity, DecoratedBarcodeView barcodeView) {
...
//            activity.finish();
//        } else if (from == 1) {
////            ScanPager.scanResult(code);
//        } else if (from == 2) {
//            ZhuanbiActivity.activity.scanResult(code);
////            PurchasePager.scanResult(code);
//            activity.finish();
//        } else {
//            activity.finish();
//        }
...
//        CaptureManagerUtil.cameraPermissionReqCode = cameraPermissionReqCode;
//    }
//}
